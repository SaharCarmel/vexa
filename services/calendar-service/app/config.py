...
# Tuning
DEFAULT_LEAD_TIME_MINUTES = int(os.getenv("DEFAULT_LEAD_TIME_MINUTES") or "2")
CALENDAR_SYNC_INTERVAL_SECONDS = int(os.getenv("CALENDAR_SYNC_INTERVAL_SECONDS") or "300")
JOIN_CHECK_INTERVAL_SECONDS = int(os.getenv("JOIN_CHECK_INTERVAL_SECONDS") or "60")
